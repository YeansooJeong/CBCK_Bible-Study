...
function StudentHomePage() {
  ...
  async function finishQuiz() {
    ...
    try { setSummary(await api.finishQuizSession(token, sessionId)) } catch { setError('퀴즈 결과를 불러오지 못했습니다.') }
  }
  ...
  if (!user) return null
  return <div className="min-h-svh bg-white px-6 py-10 dark:bg-neutral-950"><div className="mx-auto flex max-w-2xl flex-col gap-6">
