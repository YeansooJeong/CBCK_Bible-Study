...
function getSections(variant: Variant): Array<{ title: string; body: string[] }> {
  ...
  sections.push({
    title: '과목은 어떻게 만드나요?',
    body: [
      '"과목 관리"에서 새 과목(예: 창세기)을 만들고 총 회차 수를 정할 수 있어요. 신학원생들은 이 과목을 기준으로 문제를 등록하고 학습합니다.',
      '회차는 차수와 상관없이 전체 강의 순번으로 적습니다. 2차 1강이 전체 9강이면 "9"로 적어요. 총 회차 수는 참고용으로만 보여주고, 이 값을 넘는 회차도 등록할 수 있습니다.',
    ],
  })
